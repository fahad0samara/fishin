...
import { fetchUserData, updateProfile } from "../auth/authThunks";
...
<section className="pt-16">
  ...
  {(updateData.newProfileImage || user.profileImage) && !updateData.deleteProfileImage ? (
    <div className="flex flex-col items-center">
      <div className="relative">
        <img
          src={updateData.newProfileImage ? URL.createObjectURL(updateData.newProfileImage) : user.profileImage}
          alt="Profile"
          className="h-16 w-16 rounded-full"
        />
        <button
