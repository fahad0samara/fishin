...
//     // Update the images on Azure Blob storage
...
router.put(
  ...
  async (req, res) => {
    try {
      ...
      // Delete images from Azure Blob Storage that are not in the updatedData.images array
      ...
      // Update the images in the updatedData.images array
      updatedData.images = [
        ...updatedData.images.filter((imageUrl: string) =>
          existingProduct.images.includes(imageUrl)
        ),
        ...uploadedImageURLs,
      ];
